...
public class UnityOde {
  ...
  public static int getCurrentOdeContext() {
    int ret = UnityOdePINVOKE.getCurrentOdeContext();
    return ret;
  }
  ...
  public static /* cstype out */ UnityEngine.Vector3 odeJointGetAccumulatedTorque(int jointId, int bodyIdx) {
    /* csout */ IntPtr ret = UnityOdePINVOKE.odeJointGetAccumulatedTorque(jointId, bodyIdx);
	return (UnityEngine.Vector3)Marshal.PtrToStructure(ret, typeof(UnityEngine.Vector3));
  }

  public static /* cstype out */ UnityEngine.Vector3 odeJointGetAccumulatedForce(int jointId, int bodyIdx) {
    /* csout */ IntPtr ret = UnityOdePINVOKE.odeJointGetAccumulatedForce(jointId, bodyIdx);
	return (UnityEngine.Vector3)Marshal.PtrToStructure(ret, typeof(UnityEngine.Vector3));
  }
  ...
  public static bool stepOdeFast(float stepSize, bool breakOnErrors) {
    bool ret = UnityOdePINVOKE.stepOdeFast__SWIG_0(stepSize, breakOnErrors);
    return ret;
  }

  public static bool stepOdeFast(float stepSize) {
    bool ret = UnityOdePINVOKE.stepOdeFast__SWIG_1(stepSize);
    return ret;
  }

  public static bool saveOdeState(int slot, int sourceContext, bool fast_save) {
    bool ret = UnityOdePINVOKE.saveOdeState__SWIG_0(slot, sourceContext, fast_save);
    return ret;
  }

  public static bool saveOdeState(int slot, int sourceContext) {
    bool ret = UnityOdePINVOKE.saveOdeState__SWIG_1(slot, sourceContext);
    return ret;
  }

  public static bool saveOdeState(int slot) {
    bool ret = UnityOdePINVOKE.saveOdeState__SWIG_2(slot);
    return ret;
  }

  public static bool saveOdeState() {
    bool ret = UnityOdePINVOKE.saveOdeState__SWIG_3();
    return ret;
  }
  ...
  public static void odeJointSetHinge2Anchor(int jointId, float x, float y, float z) {
    UnityOdePINVOKE.odeJointSetHinge2Anchor(jointId, x, y, z);
  }

  public static void odeJointSetHinge2Axis(int jointId, int axis, float x, float y, float z) {
    UnityOdePINVOKE.odeJointSetHinge2Axis(jointId, axis, x, y, z);
  }
  ...
  public static void odeJointSetFixed(int jointId) {
    UnityOdePINVOKE.odeJointSetFixed(jointId);
  }
  ...
  public static void odeJointSetAMotorVelocitiesRadiansPerSecond(int jointId, float vel1, float vel2, float vel3) {
    UnityOdePINVOKE.odeJointSetAMotorVelocitiesRadiansPerSecond(jointId, vel1, vel2, vel3);
  }
  ...
  public static bool odeGetGeomContact(int geom1Id, int geom2Id, /* cstype output */ out UnityEngine.Vector3 out_pos, /* cstype output */ out UnityEngine.Vector3 out_normal, /* cstype output */ out UnityEngine.Vector3 out_vel) {
    /* csin pre output */ IntPtr ptr_out_pos = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(UnityEngine.Vector3)));
    /* csin pre output */ IntPtr ptr_out_normal = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(UnityEngine.Vector3)));
    /* csin pre output */ IntPtr ptr_out_vel = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(UnityEngine.Vector3)));
    try {
      bool ret = UnityOdePINVOKE.odeGetGeomContact(geom1Id, geom2Id, /* csin */ ptr_out_pos, /* csin */ ptr_out_normal, /* csin */ ptr_out_vel);
      return ret;
    } finally {
      /* csin post output */ out_pos = (UnityEngine.Vector3)Marshal.PtrToStructure(ptr_out_pos, typeof(UnityEngine.Vector3));
      Marshal.FreeHGlobal(ptr_out_pos);
