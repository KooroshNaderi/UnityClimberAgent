...
class UnityOdePINVOKE {
  ...
  [DllImport("UnityOde", EntryPoint="CSharp_getCurrentOdeContext")]
  public static extern int getCurrentOdeContext();
  ...
  [DllImport("UnityOde", EntryPoint="CSharp_odeJointGetAccumulatedTorque")]
  public static extern /* imtype out */ IntPtr odeJointGetAccumulatedTorque(int jarg1, int jarg2);

  [DllImport("UnityOde", EntryPoint="CSharp_odeJointGetAccumulatedForce")]
  public static extern /* imtype out */ IntPtr odeJointGetAccumulatedForce(int jarg1, int jarg2);

  [DllImport("UnityOde", EntryPoint="CSharp_stepOde")]
  public static extern bool stepOde(float jarg1, bool jarg2);

  [DllImport("UnityOde", EntryPoint="CSharp_stepOdeFast__SWIG_0")]
  public static extern bool stepOdeFast__SWIG_0(float jarg1, bool jarg2);

  [DllImport("UnityOde", EntryPoint="CSharp_stepOdeFast__SWIG_1")]
  public static extern bool stepOdeFast__SWIG_1(float jarg1);

  [DllImport("UnityOde", EntryPoint="CSharp_saveOdeState__SWIG_0")]
  public static extern bool saveOdeState__SWIG_0(int jarg1, int jarg2, bool jarg3);

  [DllImport("UnityOde", EntryPoint="CSharp_saveOdeState__SWIG_1")]
  public static extern bool saveOdeState__SWIG_1(int jarg1, int jarg2);

  [DllImport("UnityOde", EntryPoint="CSharp_saveOdeState__SWIG_2")]
  public static extern bool saveOdeState__SWIG_2(int jarg1);

  [DllImport("UnityOde", EntryPoint="CSharp_saveOdeState__SWIG_3")]
  public static extern bool saveOdeState__SWIG_3();
  ...
  [DllImport("UnityOde", EntryPoint="CSharp_odeJointSetHinge2Anchor")]
  public static extern void odeJointSetHinge2Anchor(int jarg1, float jarg2, float jarg3, float jarg4);

  [DllImport("UnityOde", EntryPoint="CSharp_odeJointSetHinge2Axis")]
  public static extern void odeJointSetHinge2Axis(int jarg1, int jarg2, float jarg3, float jarg4, float jarg5);
  ...
  [DllImport("UnityOde", EntryPoint="CSharp_odeJointSetFixed")]
  public static extern void odeJointSetFixed(int jarg1);
  ...
  [DllImport("UnityOde", EntryPoint="CSharp_odeJointSetAMotorVelocitiesRadiansPerSecond")]
  public static extern void odeJointSetAMotorVelocitiesRadiansPerSecond(int jarg1, float jarg2, float jarg3, float jarg4);
  ...
  [DllImport("UnityOde", EntryPoint="CSharp_odeGetGeomContact")]
  public static extern bool odeGetGeomContact(int jarg1, int jarg2, /* imtype */ IntPtr jarg3, /* imtype */ IntPtr jarg4, /* imtype */ IntPtr jarg5);
}
